...
* Download the latest pre-compiled Eupnea ChromeOS
  kernel [here](https://github.com/enter-dragon/chromeos-kernel/releases/latest)
* Download the latest pre-compiled Eupnea mainline
  kernel [here](https://github.com/enter-dragon/mainline-kernel/releases/latest)
...
1. Sign the kernel and add a cmdline to it.
   ...
   the `install-kernel`[script](https://github.com/enter-dragon/eupnea-utils/blob/main/system-scripts/install-kernel)  
