...
1. Open a terminal, clone the repo and start the script with this command:
    ```shell
    git clone --depth=1 https://github.com/enter-dragon/depthboot-builder && cd depthboot-builder && ./main.py
    ```
...
7. Please consider starring the [depthboot](https://github.com/enter-dragon/depthboot-builder) repo on GitHub to help
